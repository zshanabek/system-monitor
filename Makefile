...
FILENAMES = main.cpp Module.cpp Network.cpp Hostname.cpp OSInfo.cpp RAM.cpp Datetime.cpp CPU.cpp IMonitorDisplay.cpp IMonitorModule.cpp helpers.cpp Cat.cpp
